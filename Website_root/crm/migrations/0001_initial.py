# Generated by Django 4.2.2 on 2024-05-30 17:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='Numer kontaktowy')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('completed', models.BooleanField(default=False, verbose_name='Wykonany')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Data utworzenia')),
                ('desired_appointment_date', models.DateField(blank=True, null=True, verbose_name='Data spotkania')),
